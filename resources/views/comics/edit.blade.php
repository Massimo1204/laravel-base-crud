...
@section('main-content')
    <h1 class="text-center text-danger mt-4">Edit Comic</h1>
    @if ($errors->any())
    ...
    <div class="my-form-wrapper">
        <form class="m-5" action="{{ route('comics.update', $comic) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="form-group mb-3">
                ...
                <input type="description" class="form-control" id="description" name="description" value="{{ $comic->description }}">
            </div>
            <div class="form-group mb-3">
